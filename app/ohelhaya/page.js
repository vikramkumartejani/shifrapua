...
const faqData = [
  ...
  {
    question: "התוועדויות",
    answer: "מדי חודש מתקיימות התוועדויות קהילתיות וכלליות, בהן מתכנסות נשים לכבוד תאריכים מיוחדים וחגים סביב שולחנות ערוכים או כיבוד קל. באים מרצים מכל מיני מקומות להעשיר את המשתתפות בידע ובחוויה.    "
  },
  {
    question: "מלווה מלכה",
    answer: "בחודשי חורף מדי מברכים החודש אנו מקיימות סעודת מלווה מלכה המלווה בניגונים והרצאה בהשתתפותן של למעלה מ-150 נשים כשלעומת זאת בשבתות קיץ ישנו שיעור פרקי אבות שעובר בין בתים ובו משתתפות למעלה מ-70 נשים.    "
  },
  {
    question: "ערבי חינוך",
    answer: "פעם בחודש מתקיים ערב חינוך להורים בו מדבר רב הקהילה ועוד מרצה אורח, בנושאי חינוך, זוגיות ומשפחה.    "
  },
  {
    question: "בנות חב ד",
    answer: "בקהילה למעלה מ-200 בנות שלהן פעילות כללית ושותפת של ערבים מיוחדים, שבתונים ויציאה למבצעים.    "
  },
  {
    question: "ועדת ביקור חולים",
    answer: "ועדה שאחראית שבכל מקרה של בעיות בריאות חריגות, אישפוזים, וכו'. המשפחה תטופל, ותקבל ארוחות מסודרות, עזרה בניקיון, טיפול בילדים וכו'.    "
  },
  {
    question: "שפרה ופועה",
    answer: " מדי שנה אנו עורכות דינר שנתי שכולו קדש למען היולדת. אנו צוות שלמעלה מ-60 מתנדבות התורם מעצמו ללא גבול למען היולדות המונות כ-150 בשנה כן ירבו. היולדת מקבלת שי מכובד לאם ולילוד, בייביסיטר, ניקיון, ארוחות שבת, יום החלמה, וארוחות בקר למשך שבוע ם.    "
  },
];
